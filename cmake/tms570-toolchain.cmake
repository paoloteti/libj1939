#
# TMS570 big-endian toolchain (GNU Tools ARM Embedded)
#
set(CMAKE_SYSTEM_NAME Generic)
set(CMAKE_SYSTEM_PROCESSOR arm)
set(CMAKE_CROSSCOMPILING 1)

set(TOOLCHAIN_TRIPLE "armeb-none-eabi-" CACHE STRING "Triple prefix for arm crosscompiling tools")
...
set(CMAKE_AR           "${TOOLCHAIN_BIN_PATH}/${TOOLCHAIN_TRIPLE}ar${TOOLCHAIN_SUFFIX}")
...
set(TARGET_FLAGS "-march=armv7-r -mtune=cortex-r4 -mfloat-abi=hard -mfpu=vfpv3-d16")
set(CMAKE_EXE_LINKER_FLAGS "-mbe32 -static -nostartfiles -Wl,--gc-sections --specs=nosys.specs")

set(CMAKE_C_FLAGS "-fno-strict-aliasing ${TARGET_FLAGS} -ffunction-sections -fdata-sections")
